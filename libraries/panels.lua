...
function toggle.new(preset)
   ...
   new.cache.slider_sprite = generic_ninepatch_srite_border:copy():setOpacity(1)
   ...
   new.cache.switch_handle = gnui.newContainer():setSprite(generic_ninepatch_srite_border:copy():setRenderType("EMISSIVE_SOLID"))
